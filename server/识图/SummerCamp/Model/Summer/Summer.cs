...
namespace Model
{
    public partial class Summer
    {
        ...
        /// <summary>
        /// Returns an instance of Summer model.
        /// </summary>
        public Summer()
        {
            ...
            string modelpath = Path.Combine(Path.GetDirectoryName(dllpath), "Summer");
        ...
        /// <summary>
        /// Returns instance of Summer model instantiated from exported model path.
        /// </summary>
        ...
        /// <summary>
        /// Runs inference on Summer model for a batch of inputs.
